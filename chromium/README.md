...
As of Slackware Arm 15.0 was released, lld was added to system llvm/clang, so there is no need to bild this package any more if you are intending to build chromium/comium-ungoogled your self.
